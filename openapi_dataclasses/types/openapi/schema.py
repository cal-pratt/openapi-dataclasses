...
class OpenApiSchema:
    ...
    enum: Optional[list[Any]] = openapi_field("enum", default=None)
    """5.20.
    ...
    items: list["OpenApiSchema"] = openapi_field(
        "items",
        default_factory=list,
        decoder=lambda d: [OpenApiSchema.from_dict(d)] if isinstance(d, dict)
        else [OpenApiSchema.from_dict(v) for v in d],
    )
    additional_items: Optional[Union["OpenApiSchema", bool]] = openapi_field(
        "additionalItems",
        default_factory=list,
    ...
    format: Optional[str] = openapi_field("format", default=None)
    """7.1.
    ...
    nullable: bool = openapi_field("nullable", default=False)
    ...
    properties: dict[str, "OpenApiSchema"] = openapi_field(
        "properties",
    ...
    additional_properties: Optional[Union["OpenApiSchema", bool]] = openapi_field(
