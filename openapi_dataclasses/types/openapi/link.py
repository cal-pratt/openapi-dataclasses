...
class OpenApiLink:
    ...
    operation_ref: Optional[str] = openapi_field("operationRef", default=None)
    """
    ...
    operation_id: Optional[str] = openapi_field("operationId", default=None)
    """
    ...
    parameters: dict[str, Any] = openapi_field("parameters", default_factory={})
    """
    ...
    request_body: Any = openapi_field("requestBody", default=None)
    """
    ...
    server: Optional[OpenApiServer] = openapi_field("server", default=None)
    """
