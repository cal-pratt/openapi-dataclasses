...
class OpenApiOperation:
    responses: dict[str, OpenApiResponse] = openapi_field("responses")
    """
    ...
    tags: list[str] = openapi_field("tags", default_factory=list)
    """
    ...
    request_body: Optional[OpenApiRequestBody] = openapi_field("requestBody", default_factory=dict)
    """
